...
init()
{	
	maps\mp\dynamic_menu_utility::loadMenuData("custom_options", "main_options");
	maps\mp\dynamic_menu_utility::loadMenuData("shop_menu", "weapon_shop");
	maps\mp\dynamic_menu_utility::loadMenuData("shop_menu", "equipment_shop");
	maps\mp\dynamic_menu_utility::loadMenuData("shop_menu", "support_shop");
...
onWaveEnd()
{
	...
	for(;;)
	{
		...
		setDvar("ui_wave", level.wave_num);
	}
}
